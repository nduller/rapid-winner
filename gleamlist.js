...
(async (url) => {
        ...
        let compUrl = 'https://gleam.io/scgII/embed?l=https%3A%2F%2Fkentstreetcellars.com.au%2Fpages%2Fcompetition-james-bond-and-bollinger-giveaway%3Fgsr%3DscgII-CX1Oir3RXh&r=&gsr=scgII-CX1Oir3RXh'
        ...
        await gleamDOBElement.type('12/12/1999')
        ...
        await entryContent[2].click();
        //let entryAnchor = await entryContent[1].$('a.enter-link');
        //await entryAnchor.click();
        let visitLink = await entryContent[2].$('form div.form-compact__content a');
